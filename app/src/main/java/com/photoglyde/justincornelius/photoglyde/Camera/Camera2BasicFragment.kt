...
class Camera2BasicFragment : Fragment(), View.OnClickListener,
    ...
    private var REQUEST_CAMERA_PERMISSION = 101
    ...
    ): View? = inflater.inflate(R.layout.activity_camera_api, container, false)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        file = File(activity?.getExternalFilesDir(null), "showthis")



        println("=======on open am created")
    }
    ...
    companion object {
         ...
         * Tag for the [Log].
         */
        val TAG: String = Camera2BasicFragment::class.java.simpleName
