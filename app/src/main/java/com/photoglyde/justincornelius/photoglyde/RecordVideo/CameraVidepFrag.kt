...
import com.photoglyde.justincornelius.photoglyde.Camera.AutoFitTextureView
...
class CameraVideoFrag : Fragment(), View.OnClickListener,
        ActivityCompat.OnRequestPermissionsResultCallback {

    private val FRAGMENT_DIALOG = "dialog"
    lateinit var mVideoPrev:ImageView
    ...
    private val stateCallback = object : CameraDevice.StateCallback() {
        ...
        override fun onOpened(cameraDevice: CameraDevice) {
            ...
            this@CameraVideoFrag.cameraDevice = cameraDevice
            startPreview()
        ...
        override fun onDisconnected(cameraDevice: CameraDevice) {
            cameraOpenCloseLock.release()
            cameraDevice.close()
            this@CameraVideoFrag.cameraDevice = null
        }
...
//        val bitmap = ThumbnailUtils.createVideoThumbnail(nextVideoAbsolutePath, MediaStore.Video.Thumbnails.MINI_KIND)
//        val thumbnailUri = Helper.getImageUri(this@CameraVideoFrag.requireContext(), bitmap)
//        val createdOn = Helper.getDateTimeLong()
//        val videoUri = Uri.fromFile(File(nextVideoAbsolutePath))
//        val dimen = Helper.getVideoHeight(videoUri, this@CameraVideoFrag.requireContext())
//        val width = dimen.first()
//        val height = dimen.last()

      //  Helper.videoRender(this.requireContext(), nextVideoAbsolutePath)
    ...
    private fun chooseOptimalSize(
        ...
        return if (bigEnough.isNotEmpty()) {
            Collections.min(bigEnough, Camera2BasicFragment.CompareSizesByArea())
        } else {
            choices[0]
        }
    }
    ...
    companion object {
        fun newInstance(): CameraVideoFrag = CameraVideoFrag()
    }
