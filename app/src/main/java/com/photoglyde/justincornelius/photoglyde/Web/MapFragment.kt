...
class MapFragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val location = GlobalVals.currentCore?.user?.location
        var lat_long:LatLng?
        ...
        if (lat_long != null) {
               ...
               // googleMap.moveCamera(CameraUpdateFactory.newLatLng(lat_long))
                ...
                Picasso.get().load(GlobalVals.currentCore?.urls?.regular).into(target)
...
//        }
    ...
    interface OnFragmentInteractionListener {
        ...
        fun onFragmentInteraction(ani: String, fragment: Fragment)
    }
