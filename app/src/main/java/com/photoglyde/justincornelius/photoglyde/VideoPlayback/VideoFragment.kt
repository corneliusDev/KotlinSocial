 ...
 *
 */
class VideoFragment : Fragment(), VideoControllerContract.View {
...
//    }
    ...
    private fun init() {
        ...
        if (bundle != null) {
            val i = bundle.getString("VIDEO")
            videoUrl = i
            println("This is the video $i")
        }

        println("This is the video $videoUrl")

        //        val videoUrl = activity?.intent!!.getStringExtra(VideoActivity.VIDEO_URL_EXTRA)

        videoView = view!!.findViewById(R.id.video_view)

        videoView.player = presenter.getPlayer().getPlayerImpl(this.requireContext())
