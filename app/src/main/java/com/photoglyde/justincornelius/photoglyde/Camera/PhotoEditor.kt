...
class PhotoEditor : Activity(), PermissionRequest.Response {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val hasOption = intent.hasExtra("option")
        ...
        if (hasOption){
            when(option){
                ...
                "gallery" -> {openSystemGalleryToSelectAnImage()}
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == GALLERY_RESULT) {
            ...
            val newIntent = Intent(this, EditPhoto::class.java)
            newIntent.putExtra("source", resultURI.toString())
            startActivityForResult(newIntent, 110)
            finish()
